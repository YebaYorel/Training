...
def grille(chemin, numero, titre, contexte, critiques, seuil_note, critiques_bloquants, obs):
    ...
    f += [t2, E(4)]
    f += [encadre("Consignes de débrief (formateur)", obs, coul=VERT, fond=colors.HexColor("#E8F3EC"))]
...
grille("../04_grilles_evaluation/Grille_evaluation_1_Posture_manageriale.pdf", 1,
  "Posture managériale en situation de réunion",
  ["Support : jeu n°4 « La réunion de 9h » — 8 minutes de mise en situation.",
   "Le stagiaire anime une réunion avec quatre collaborateurs jouant un rôle secret.",
   "Sujet imposé : un nouveau planning refusé par l'équipe.",
   "L'évaluation porte sur des comportements observés, jamais sur la personnalité."],
  [("Ouverture et cadrage",
    "Il rappelle l'objectif en une phrase et annonce la durée, dans les 60 premières secondes."),
   ...
   ("Régulation de la parole",
    "Il donne la parole avant de donner son avis, relance nommément le silencieux, "
    "borne le bavard sans le disqualifier."),
   ("Posture et voix",
    "Appuis stables, mains visibles, regard balayé vers chacun, débit ralenti, "
    "usage d'au moins un silence."),
   ("Traitement du désaccord",
    "Il accueille l'objection, la reformule et demande une condition de réussite. "
    "Il critique le fait, jamais la personne. Aucun recadrage public."),
   ("Tenue du cadre",
    "Il rappelle la règle applicable à tous, ne crée pas d'exception non expliquée, "
    "ne se désolidarise pas de la décision de la direction."),
...
grille("../04_grilles_evaluation/Grille_evaluation_2_Usage_responsable_IA.pdf", 2,
  ...
  ["Support : jeu n°8 « Mon chantier IA » — présentation orale de 60 secondes, "
   "appuyée sur la fiche complétée.",
   "Le stagiaire choisit une tâche réelle de son quotidien et construit un usage d'IA conforme.",
